...
2. **Load the right rules.** The detailed standards in `.claude/rules/` auto-apply by path as you read matching files; if one is not already in context, `Read` it directly:
